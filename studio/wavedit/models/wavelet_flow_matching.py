...
class WaveletFlowMatching(nn.Module):
    ...
    def sample(
        ...
        # Studio vendored patch: allow autocast on Apple MPS as well as CUDA. The
        # desktop engine passes float32 by default (always safe); bf16 is opt-in
        # and is auto-retried at float32 if the device rejects it.
